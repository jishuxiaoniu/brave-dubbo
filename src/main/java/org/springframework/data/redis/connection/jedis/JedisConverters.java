...
import org.springframework.data.redis.connection.convert.*;
...
abstract public class JedisConverters extends Converters {
	...
	static {
		...
		GEO_COORDINATE_TO_POINT_CONVERTER = new Converter<GeoCoordinate, Point>() {
			@Override
			public Point convert(GeoCoordinate geoCoordinate) {
				return geoCoordinate != null ? new Point(geoCoordinate.getLongitude(), geoCoordinate.getLatitude()) : null;
			}
		};
		LIST_GEO_COORDINATE_TO_POINT_CONVERTER = new ListConverter<GeoCoordinate, Point>(
